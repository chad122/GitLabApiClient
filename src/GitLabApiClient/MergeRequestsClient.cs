...
namespace GitLabApiClient
{
    ...
    public sealed class MergeRequestsClient : IMergeRequestsClient
    {
        ...
        /// <param name="projectId">The ID, path or <see cref="Project"/> of the project.</param>
        /// <param name="mergeRequestIid">The Internal Merge Request Id.</param>
        public async Task<IList<Commit>> GetCommitsAsync(ProjectId projectId, int mergeRequestIid) =>
            await _httpFacade.GetPagedList<Commit>($"projects/{projectId}/merge_requests/{mergeRequestIid}/commits");
